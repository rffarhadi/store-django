...
module.exports = function(XRegExp) {
    ...
    function deanchor(pattern) {
        ...
        // built/generated by XRegExp sometimes includes them
        var leadingAnchor = /^(?:\(\?:\))*\^/;
        var trailingAnchor = /\$(?:\(\?:\))*$/;
...
module.exports = function(XRegExp) {
    ...
    XRegExp.matchRecursive = function(str, left, right, flags, options) {
        ...
        while (true) {
            ...
            // 0  | 0  | 1  | throw
            // 0  | 0  | 0  | break
            // The paths above don't includes the sticky mode special case. The loop ends after the
 ...
 * perform a global search and replace, use the optional `scope` argument or includes flag g if using
 ...
 * hexadecimal number from 0-10FFFF, and can includes leading zeros. Requires the native ES6 `u` flag
